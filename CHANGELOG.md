...
This is the stable, non-prerelease artifact for the bounded experiment. It has no
production-readiness, stable CLI, stable Rust API, stable receipt format, other-platform, or
compatibility claim.
