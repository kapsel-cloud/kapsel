...
Status: v0.2.0 Kubernetes effect-gateway beta selected. Lifecycle unification is complete; the
bounded Application/interface packet is active, and publication and all later packets remain ordered
and gated.
...
|     2 | [KAP-0059](KAP-0059.md) | Active       | Adopted beta interfaces and deeper Application/CLI/MCP locality                                      |
