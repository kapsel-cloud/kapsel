...
The native binary composes the HTTP boundary, private handoff, runner, scheduler, cleanup,
operator-stop, and periodic-retention modes. The concrete scheduler uses only the fixed
