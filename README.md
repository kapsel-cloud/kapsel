...
| Fixed public sandbox service package             | Deterministic orchestration implemented; live deployment unproved |
...
public sandbox. Its deterministic service package is implemented, but no sandbox deployment or
