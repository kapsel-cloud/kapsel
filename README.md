...
public sandbox. Its deterministic service package and corrected provider-neutral Gate 1 execution
fixture are accepted offline evidence. No provider is selected and no sandbox deployment or public
traffic is approved.
