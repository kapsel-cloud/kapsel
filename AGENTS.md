...
2. Read the [technical task route](tasks/README.md), completed
   ...
   completed migration packet [KAP-0060](tasks/KAP-0060.md), and active release-source locality
   packet [KAP-0064](tasks/KAP-0064.md). The [evaluator evidence packet](tasks/KAP-0047.md) is
