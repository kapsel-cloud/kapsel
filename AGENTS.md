...
2. Read the [technical task route](tasks/README.md), completed
   ...
   [KAP-0062](tasks/KAP-0062.md). Candidate-correction packet [KAP-0065](tasks/KAP-0065.md) is
   active after fresh documentation review found bundled status contradictions. Release acceptance
   packet [KAP-0063](tasks/KAP-0063.md) is blocked until KAP-0065 produces a replacement candidate;
   publication still requires explicit approval. The [evaluator evidence packet](tasks/KAP-0047.md)
   is post-release. The [sandbox deployment](tasks/KAP-0053.md) and [umbrella](tasks/KAP-0050.md)
   remain paused.
...
`kubernetes.set_deployment_image` capability, but fresh documentation review found bundled status
contradictions. KAP-0065 now owns narrow correction and replacement-candidate evidence. KAP-0063
remains blocked until that replacement is accepted for rehearsal, while publication remains
separately gated. The release owner is [`docs/V0.2.md`](docs/V0.2.md); lifecycle, receiver-result,
and receipt semantics remain owned by
