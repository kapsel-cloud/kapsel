...
Owns: Concise definitions needed to understand the current effect-gateway experiment.
...
| experiment receipt   | Signed prototype disclosure of frozen request, receiver, result, and non-claim facts.                              | [effect-gateway owner](EFFECT_GATEWAY.md) |
